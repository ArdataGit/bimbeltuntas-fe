      ...
      <div className=" ">
        <div className="flex flex-col gap-y-5 md:flex-row md:items-center justify-start md:justify-between header-section w-full">
          <div className="title flex justify-between items-end">
            ...
            <Link
              // to={'my-class/18/tryout/29/15/91835/statistik'}
              to={
                isBimbel
                  ? `/my-class/${id}/bimbel/mini-test/${paketFK}/${paketId}/riwayat`
                  : `/my-class/${id}/tryout/${paketFK}/${paketId}/riwayat`
              }
              className="text-[14px] ml-4 !text-indigo-500 flex items-center underline"
            >
              Pembahasan
              {<IconArrowRight className="ml-1 w-3" />}
            </Link>
          </div>
        </div>
        <div className="mt-2 ">
