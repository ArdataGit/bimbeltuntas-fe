...
export default function App({ children }: LayoutProps) {
  ...
  useEffect(() => {
    // Hanya aktif jika tidak dijalankan di localhost
    if (window.location.hostname !== 'localhost') {
      ...
      const devtools = () => {
        ...
        Object.defineProperty(element, 'id', {
          get: function () {
            ...
            // window.location.replace("https://www.google.com"); // Optional action
          },
        });
        console.log(element);
      };
      ...
      const checkDevTools = setInterval(devtools, 1000);
          ...
          {showDropdownProfileMobile && (
            <div className="profile-dropdown absolute right-0 mt-2 top-12 bg-white border rounded-md shadow-md py-2 w-36 z-[99]">
              <button
                ...
                onClick={() => {
                  navigate(
                    account?.role === 'ADMIN' ? 'profile-admin' : '/profile'
                  );
